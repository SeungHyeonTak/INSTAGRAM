...
class DirectMessage(models.Model):
    """1:1 개인 메시지"""
    user_from = models.ForeignKey('account.User', related_name='dm_from', on_delete=models.CASCADE)  # 보내는 사람
    user_to = models.ForeignKey('account.User', related_name='dm_to', on_delete=models.CASCADE)  # 받는 사람
    content = models.TextField(verbose_name=_('message 내용'))
