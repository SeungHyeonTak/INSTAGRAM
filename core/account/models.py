...
class User(AbstractBaseUser):
    ...
    photo = models.ImageField(verbose_name=_('프로필 사진'), upload_to=get_user_photo_path, blank=True)  # aws s3 경로 추가하기
...
class UserEmailAuthentication(models.Model):
    ...
    security_code = models.CharField(verbose_name=_('보안코드'), max_length=10)
